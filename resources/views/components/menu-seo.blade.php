...
@else
  <meta property="og:image"
    content="{{ $menu->getFirstMediaUrl('og_image', 'og_image') ?: asset('images/default-og.jpg') }}" />
...
@else
  <link rel="icon" type="image/x-icon" href="{{ $menu->getFirstMediaUrl('favicon', 'favicon') ?: asset('favicon.png') }}">
@endif